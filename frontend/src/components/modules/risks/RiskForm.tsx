// src/components/modules/risks/RiskForm.tsx

import React, { useState, useEffect } from 'react';
import { X, Save, AlertTriangle, Plus, Trash2, User, Calendar, Target } from 'lucide-react';
...
const RiskForm: React.FC<RiskFormProps> = ({ risk, isOpen, onClose, onSave }) => {
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="business-process">Proceso de Negocio</option>
                ...
                <div className="border-t pt-6">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-lg font-medium text-gray-900">Acciones de Mitigación</h4>
                    <button
                      type="button"
                  ...
                  <div className="space-y-4">
                    {mitigationActions.map((action, index) => (
                      <div key={action.id} className="border rounded-lg p-4 bg-gray-50">
                        <div className="flex items-center justify-between mb-3">
                          <h5 className="font-medium text-gray-900">Acción {index + 1}</h5>
                          <button
                            type="button"
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                          <div className="lg:col-span-2">
                            ...
                            <input
                              ...
                              onChange={(e) => updateMitigationAction(action.id, { description: e.target.value })}
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) => updateMitigationAction(action.id, { responsible: e.target.value })}
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            >
                              <option value="">Seleccionar empleado</option>
                              {employees.map(employee => (
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => updateMitigationAction(action.id, { dueDate: e.target.value })}
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                          </div>
                          ...
                          <div>
                            ...
                            <select
                              value={action.status}
                              onChange={(e) => updateMitigationAction(action.id, { status: e.target.value as any })}
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            >
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => updateMitigationAction(action.id, { progress: Number(e.target.value) })}
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                          </div>
                          ...
                          <div className="lg:col-span-2">
                            ...
                            <textarea
                              rows={2}
                              value={action.notes}
                              onChange={(e) => updateMitigationAction(action.id, { notes: e.target.value })}
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    {mitigationActions.length === 0 && (
                      <div className="text-center py-4 text-gray-500">
                        No hay acciones de mitigación definidas
                      </div>
                    )}
                  </div>
                </div>
                ...
                {/* Assets and Systems */}
                <div className="border-t pt-6">
                  <h4 className="text-lg font-medium text-gray-900 mb-4">Activos y Sistemas Afectados</h4>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          setFormData(prev => ({ ...prev, affectedAssets: values }));
                        }}
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          const values = Array.from(e.target.selectedOptions, option => option.value);
                          setFormData(prev => ({ ...prev, affectedSystems: values }));
                        }}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 h-32"
                      >
                        {systems.map(system => (
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className={`text-2xl font-bold ${getRiskLevelColor(formData.inherentRisk)}`}>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className={`text-2xl font-bold ${getRiskLevelColor(formData.residualRisk)}`}>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className="text-2xl font-bold text-green-600">
                        {((1 - formData.residualRisk / formData.inherentRisk) * 100).toFixed(0)}%
                      </div>
                    </div>
                  </div>
                </div>
